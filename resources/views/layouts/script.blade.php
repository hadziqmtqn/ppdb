...
<script src="{{ asset('materialize/assets/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
<script src="{{ asset('materialize/assets/vendor/libs/jquery-repeater/jquery-repeater.js') }}"></script>
...
<script src="{{ asset('materialize/assets/vendor/libs/chartjs/chartjs.js') }}"></script>
...
<script src="{{ asset('materialize/js/block-ui.js') }}"></script>
<script src="{{ asset('materialize/js/extra.js') }}"></script>
<script src="{{ asset('materialize/js/select2.js') }}"></script>
<script src="{{ asset('materialize/js/form-picker.js') }}"></script>
<script src="{{ asset('materialize/js/datatable.js') }}"></script>
<script src="{{ asset('materialize/js/scroll-perfect.js') }}"></script>
<script src="{{ asset('materialize/assets/js/cards-actions.js') }}"></script>
