                ...
                <form id="formEdit" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" onsubmit="return false">
                    <div class="col-12 fv-plugins-icon-container">
                        <div class="form-floating form-floating-outline mb-3">
                            <input type="url" class="form-control" name="domain" id="editDomain" placeholder="Domain">
                            <label for="editDomain">Domain</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-3">
                            <input type="url" class="form-control" name="api_key" id="editApiKey" placeholder="API Key">
