document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('formAcceptance');
    const username = form.dataset.username;
    const btnSubmit = document.getElementById('btn-submit-acceptance');
    ...
    btnSubmit.addEventListener('click', async function (event) {
        ...
        try {
            const response = await axios.post(`/acceptance-registration/${username}/store`, formData);
