$(function () {
    ...
    const dataTable = $(table).DataTable({
        ...
        order: [[1, 'asc']],
        ajax: {
            url: "/educational-group/datatable",
            type: "POST",
            headers: {
        ...
        columns: [
            ...
            {data: 'name', name: 'name'},
            {data: 'nextEducationalLevel', name: 'nextEducationalLevel'},
    ...
    $('#modalEdit').on('show.bs.modal', function (event) {
        ...
        const nextEducationalLevel = button.data('next-educational-level');

        $('#editName').val(name);
        $('#editNextEducationalLevel').val(nextEducationalLevel);
        ...
        $('#btn-edit').off('click').on('click', function() {
            ...
            // menggunakan axios
            axios.put(`/educational-group/${slug}/update`, $('#formEdit').serialize())
                .then(response => {
                    unBlockUi();
